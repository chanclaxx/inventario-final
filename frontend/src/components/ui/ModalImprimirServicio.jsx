// src/components/ui/ModalImprimirServicio.jsx
// Modal para elegir entre impresión POS (térmica) o PDF al imprimir un comprobante de servicio.

import { useState } from 'react';
import { Modal }    from './Modal';
import { Printer, FileDown, Share2, Loader2, X } from 'lucide-react';
import useExportarPdfServicio from '../../hooks/useExportarPdfServicio';
      ...
      <div className="flex flex-col gap-5">
        ...
        {formato === 'pdf' && (
          <div className="flex flex-col gap-2">
            <p className="text-xs text-gray-400 bg-gray-50 rounded-xl px-3 py-2.5">
              Se descargará un PDF en formato A4 con el detalle completo del servicio.
            </p>
